...
final class SubCategoryCVCell: UICollectionViewCell {
    ...
    func configure(with category: MainModels.Response.SubCategories) {
...
private extension SubCategoryCVCell {
