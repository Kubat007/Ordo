...
#ifndef REALHTTP_SWIFT_H
#define REALHTTP_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="RealHTTP",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC8RealHTTP19HTTPStubURLProtocol")
@interface HTTPStubURLProtocol : NSURLProtocol
...
+ (BOOL)requestIsCacheEquivalent:(NSURLRequest * _Nonnull)requestA toRequest:(NSURLRequest * _Nonnull)requestB SWIFT_WARN_UNUSED_RESULT;
...
- (nonnull instancetype)initWithTask:(NSURLSessionTask * _Nonnull)task cachedResponse:(NSCachedURLResponse * _Nullable)cachedResponse client:(id <NSURLProtocolClient> _Nullable)client OBJC_DESIGNATED_INITIALIZER;
- (void)startLoading;
- (void)stopLoading;
@end
